...
if (!empty($_POST)) {
    ...
    if (!empty($_FILES['uploaded_file']['name'])) {
        ...
        if (!$error && $_FILES['uploaded_file']['size'] > FILE_PHOTO_MAX_SIZE) {
        ...
        if (!$error) {
            ...
            if (file_exists($new_file_name)) {
                ...
                $result = $imglib->createPhotoImg($new_file_name, true, true);
                ...
                if (!$result['error']) {
                    ...
                    if (auth::isSession()) {
                        ...
                        auth::setCurrentUserPhotoUrl($result['lowPhotoUrl']);
                    }
                }
            }
