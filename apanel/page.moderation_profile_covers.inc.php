    ...
    <div id="main-wrapper">
        ...
        <script type="text/javascript">
            ...
            Stream.moreItems = function (offset) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/' + admin_panel + '/moderation_profile_covers',
    ...
    function draw($item, $LANG)
    {
        ?>
            ...
            <tr class="data-item" data-id="<?php echo $item['id']; ?>">
                ...
                <td>
                    <a href="javascript:void(0)" onclick="Stream.reject('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>', 'cover_reject'); return false;" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Reject"><i class="ti-trash"></i> <?php echo $LANG['apanel-action-reject']; ?></a>
                    <span> | </span>
                    <a href="javascript:void(0)" onclick="Stream.approve('<?php echo $item['id']; ?>', '<?php echo admin::getAccessToken(); ?>', 'cover_approve'); return false;" class="text-inverse" title="" data-toggle="tooltip" data-original-title="Approve"><i class="ti-check"></i> <?php echo $LANG['apanel-action-approve']; ?></a>
                </td>
            </tr>
