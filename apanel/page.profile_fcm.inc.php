<?php
    ...
    if (!empty($_POST)) {
        ...
        header("Location: /".APP_ADMIN_PANEL."/profile_fcm?id=".$accountId);
        exit;
    }
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40"  method="post" action="/<?php echo APP_ADMIN_PANEL; ?>/profile_fcm?id=<?php echo $accountId; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type">
                                            <option selected="selected" value="<?php echo GCM_NOTIFY_SYSTEM; ?>"><?php echo $LANG['apanel-fcm-type-for-all']; ?></option>
                                            <option value="<?php echo GCM_NOTIFY_PERSONAL; ?>"><?php echo $LANG['apanel-fcm-type-for-authorized']; ?></option>
                                        </select>
                                    </div>
                ...
                <?php
                    ...
                    switch ($itemObj['msgType']) {
                        ...
                        case GCM_NOTIFY_SYSTEM: {
                            ...
                            echo $LANG['apanel-fcm-type-for-all'];
                            break;
                        }

                        case GCM_NOTIFY_PERSONAL: {

                            echo $LANG['apanel-fcm-type-for-authorized'];
                            break;
                        }
