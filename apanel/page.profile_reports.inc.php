<?php
    ...
    if (!empty($_POST)) {
		...
		$result = $reports->getItems($pageId, REPORT_TYPE_PROFILE, $accountInfo['id']);
    ...
    $page_title = $LANG['apanel-label-stats-profile-reports']." | Admin Panel";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><?php echo $LANG['apanel-label-stats-profile-reports']; ?></li>
                        </ol>
                    </div>
                </div>
                ...
                <?php
                    ...
                    $result = $reports->getItems(0, REPORT_TYPE_PROFILE, $accountInfo['id']);
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex no-block">
                                            <h4 class="card-title"><?php echo $LANG['apanel-label-stats-profile-reports']; ?> (<span class="count"><?php echo $result['itemsCount']; ?></span>)</h4>
                                        </div>
		...
		<script type="text/javascript">
			...
			$(document).on('click', 'a.more-items', function() {
				...
				$.ajax({
					type: 'POST',
					url: "/" + admin_panel + "/profile_reports?id=" + profile_id,
					data: "pageId=" + pageId,
					dataType: 'json',
					timeout: 30000,
