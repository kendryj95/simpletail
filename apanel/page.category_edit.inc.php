<?php
    ...
    if (!empty($_POST)) {
		...
		if ($authToken === helper::getAuthenticityToken() && !APP_DEMO && strlen($title) != 0) {
		    ...
		    $category->edit($categoryId, $categoryInfo['mainCategoryId'], $title);
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            ...
                                            <form id="new-category-form" class="input-form-2" method="post" action="/<?php echo APP_ADMIN_PANEL; ?>/category_edit?id=<?php echo $categoryInfo['id']; ?>">
