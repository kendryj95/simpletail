...
$B['APP_HOST'] = "localhost/simpletail"; // your domain name (WARNING - without http://, https:// and www), for example: yourdomain.com
...
$B['DB_USER'] = "root";                             //your db user
$B['DB_PASS'] = "";                         //your db password
$B['DB_NAME'] = "simpletail";                             //your db name
