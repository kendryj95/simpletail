...
class category extends db_connect
{
    ...
    public function add($mainCategoryId, $title)
    {
        $result = array(
            "error" => true,
        ...
        $stmt = $this->db->prepare("INSERT INTO category (mainCategoryId, title, createAt) value (:mainCategoryId, :title, :createAt)");
        $stmt->bindParam(":mainCategoryId", $mainCategoryId, PDO::PARAM_INT);
    ...
    public function edit($itemId, $mainCategoryId, $title)
    {
        $result = array(
            "error" => true,
            "error_code" => ERROR_UNKNOWN);
        ...
        $stmt = $this->db->prepare("UPDATE category SET mainCategoryId = (:mainCategoryId), title = (:title) WHERE id = (:itemId)");
