...
class items extends db_connect
{
    ...
    public function add($appType, $category, $subCategoryId, $title, $description, $content, $imgUrl, $allowComments = 1, $price = 0.00, $postArea = "", $postCountry = "", $postCity = "", $postLat = "0.000000", $postLng = "0.000000", $currency = 3, $phoneNumber = "", $countryId = 0, $ad_logistic_costs = "", $externalShippingPacking1 = 0, $externalShippingPacking2 = 0, $externalShippingPacking3 = 0, $internalShippingPackingDetail = "", $externalShippingPackingDetail = "", $externalShippingPackingGrs = 0, $unitMeasure = "", $quantityPiecesReferences = 0, $eanCode = "", $productCertifications = "", $productAvailability = "", $ingredients = "", $keywordsProduct = "", $amount_product = 0, $amount_product_value = "", $total_weight = 0, $quantity_items_per_case = 0)
    {
        ...
        $stmt = $this->db->prepare("INSERT INTO items (itemUrl, appType, allowComments, fromUserId, phoneNumber, category, subCategory, itemTitle, itemDesc, itemContent, imgUrl, previewImgUrl, price, currency, area, country, city, lat, lng, createAt, ip_addr, u_agent, countryId, logistic_costs, externalShippingPacking1, externalShippingPacking2, externalShippingPacking3, internalShippingPackingDetail, externalShippingPackingDetail, externalShippingPackingGrs, unitMeasure, quantityPiecesReferences, eanCode, productCertifications, productAvailability, ingredients, keywordsProduct, amount_product, amount_product_value, total_weight, quantity_items_per_case) value (:itemUrl, :appType, :allowComments, :fromUserId, :phoneNumber, :category, :subCategory, :itemTitle, :itemDesc, :itemContent, :imgUrl, :previewImgUrl, :price, :currency, :area, :country, :city, :lat, :lng, :createAt, :ip_addr, :u_agent, :countryId, :logistic_costs, :externalShippingPacking1, :externalShippingPacking2, :externalShippingPacking3, :internalShippingPackingDetail, :externalShippingPackingDetail, :externalShippingPackingGrs, :unitMeasure, :quantityPiecesReferences, :eanCode, :productCertifications, :productAvailability, :ingredients, :keywordsProduct, :amount_product, :amount_product_value, :total_weight, :quantity_items_per_case)");
        ...
        $stmt->bindParam(":logistic_costs", $ad_logistic_costs, PDO::PARAM_STR);
    ...
    public function edit($itemId, $category, $subCategoryId, $title, $imgUrl, $content, $allowComments, $price, $area = "", $country = "", $city = "", $lat = "0.000000", $lng = "0.000000", $currency = 3, $phoneNumber = "", $countryId = 0, $ad_logistic_costs = "", $externalShippingPacking1 = 0, $externalShippingPacking2 = 0, $externalShippingPacking3 = 0, $internalShippingPackingDetail = "", $externalShippingPackingDetail = "", $externalShippingPackingGrs = 0, $unitMeasure = "", $quantityPiecesReferences = 0, $eanCode = "", $productCertifications = "", $productAvailability = "", $ingredients = "", $keywordsProduct = "", $amount_product = 0, $amount_product_value = "", $total_weight = 0, $quantity_items_per_case = 0)
    {
        $result = array(
            "error" => true,
            "error_code" => ERROR_UNKNOWN);
        ...
        $stmt->bindParam(":currency", $currency, PDO::PARAM_INT);
        $stmt->bindParam(":countryId", $countryId, PDO::PARAM_INT);
        $stmt->bindParam(":logistic_costs", $logistic_costs, PDO::PARAM_STR);
        $stmt->bindParam(":externalShippingPacking1", $externalShippingPacking1, PDO::PARAM_INT);
        $stmt->bindParam(":externalShippingPacking2", $externalShippingPacking2, PDO::PARAM_INT);
        $stmt->bindParam(":externalShippingPacking3", $externalShippingPacking3, PDO::PARAM_INT);
        $stmt->bindParam(":internalShippingPackingDetail", $internalShippingPackingDetail, PDO::PARAM_STR);
    ...
    public function quickInfo($row)
    {
        ...
        $result = array("error" => false,
                        ...
                        "logistic_costs" => $row['logistic_costs'],
                        "externalShippingPacking1" => $row['externalShippingPacking1'],
                        "externalShippingPacking2" => $row['externalShippingPacking2'],
                        "externalShippingPacking3" => $row['externalShippingPacking3'],
                        "internalShippingPackingDetail" => $row['internalShippingPackingDetail'],
                        "externalShippingPackingDetail" => $row['externalShippingPackingDetail'],
                        "externalShippingPackingGrs" => $row['externalShippingPackingGrs'],
                        "unitMeasure" => $row['unitMeasure'],
                        "quantityPiecesReferences" => $row['quantityPiecesReferences'],
                        "eanCode" => $row['eanCode'],
                        "productCertifications" => $row['productCertifications'],
