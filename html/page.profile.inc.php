...
<div class="page">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <a class="btn btn-primary"
                                           href="/"><?php echo $LANG['action-back-to-main-page']; ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="profile-main-cover">
                                            <div class="cover-wrapper d-flex">
                                                ...
                                                <div class="profile-cover-img"
                                                     style="background-image: url(<?php echo $profileInfo['normalCoverUrl']; ?>);"></div>
                                                <?php
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="profile-photo-container">
                                                    ...
                                                    <a class="profile-photo-link"
                                                       href="<?php echo $profileInfo['normalPhotoUrl']; ?>">
                                                        <div class="profile-photo"
                                                             style="background-image: url(<?php echo $profileInfo['bigThumbnailUrl']; ?>);"
                                                             onclick="blueimp.Gallery($('.profile-photo-link')); return false"></div>
                                                    </a>
                                                    <?php
                                                ...
                                                <div class="w-100 justify-content-end profile-main-info-container">
                                                    <div class="fullname-line ">
                                                        ...
                                                        if ($profileInfo['verified']) {
                                                            ...
                                                            ?>
                                                            <span class="user-badge user-verified-badge ml-1"
                                                                  rel="tooltip"
                                                                  title="<?php echo $LANG['label-account-verified']; ?>"><i
                                                        ...
                                                        if ($profileInfo['online']) {
                                                            ...
                                                            <i class="online-status bg-gray" rel="tooltip"
                                                               title="<?php echo $profileInfo['lastAuthorizeTimeAgo']; ?>"></i>
                                                            <?php
                                                        }
                                                        ?>
                                                        ...
                                                        <div class="addon-line d-flex align-content-center flex-column flex-sm-row">
                                                            <div class="user-link mt-2 mt-sm-0 ml-0">
                                                                ...
                                                                <a target="_blank" rel="nofollow"
                                                                   href="/go?to=<?php echo $profileInfo['website']; ?>"><?php echo $profileInfo['website']; ?></a>
                                                            </div>
                                                        </div>
                                                        <?php
                                                    }
                                                    ...
                                                    if (strlen($profileInfo['url_content_company']) != 0) {
                                                        ...
                                                        <div class="addon-line d-flex align-content-center flex-column flex-sm-row">
                                                            <div class="user-link mt-2 mt-sm-0 ml-0">
                                                                <i class="fa fa-link""></i>
                                                                <a target="_blank" rel="nofollow"
                                                                   href="/go?to=<?php echo $profileInfo['url_content_company']; ?>"><?php echo $profileInfo['url_content_company']; ?></a>
                                                            </div>
                                                        </div>
                                                        <?php
                                                    }
                                                    ...
                                                    if (auth::getTypeuser() === "STORE") {
                                                        if (strlen($profileInfo['categories']) != 0) {
                                                            $general = new general($dbo);
                                                            $categories = $general->getCategoriesByIds($profileInfo['categories']);
                                                            ?>
                                                            <div class="addon-line d-flex align-content-center flex-column flex-sm-row">
                                                                <div class="user-bio mt-2 mt-sm-0 ml-0">
                                                    ...
                                                    <?php if ($profileInfo['pdf_document'] != ""): ?>
                                                        <div class="addon-line d-flex align-content-center flex-column flex-sm-row">
                                                            <div class="user-link mt-2 mt-sm-0 ml-0">
                                                                ...
                                                                <a target="_blank" rel="nofollow"
                                                                   href="<?= APP_URL . "/" . $profileInfo['pdf_document'] ?>"><?= $LANG['text-see-pdf'] ?></a>
                                                            </div>
                                                        </div>
                                                    <?php endif ?>
                                        ...
                                        if (auth::getCurrentUserId() != 0) {
                                            ...
                                            <div class="profile-info-block profile-main-actions text-right">
                                                ...
                                                if ($myProfile) {
                                                    ...
                                                    ?>
                                                    <button class="btn btn-primary mb-2 mb-sm-0" data-toggle="modal"
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                                class="btn btn-secondary dropdown-toggle mb-2 mb-sm-0"
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <button class="dropdown-item report-button"
                                                                    data-toggle="modal"
                                                                    data-target="#new-report"><?php echo $LANG['action-report']; ?></button>
                                                            <?php
                                                            ...
                                                            if (!$myProfile && !$profileInfo['error'] && $profileInfo['state'] == ACCOUNT_STATE_ENABLED) {
                                                                ...
                                                                if ($profileInfo['blocked']) {
                                                                    ...
                                                                    <button class="dropdown-item block-button"
                                                                            data-toggle="modal"
                                                                            data-target="#profile-unblock-dlg"><?php echo $LANG['action-unblock']; ?></button>
                                                                    <?php
                                                                    ...
                                                                    <button class="dropdown-item block-button"
                                                                            data-toggle="modal"
                                                                            data-target="#profile-block-dlg"><?php echo $LANG['action-block']; ?></button>
                                                                    <?php
                                            ...
                                            <div class="profile-info-block profile-main-actions">
                                                ...
                                                <a class="btn btn-primary mr-1"
                                                   href="/signup"><?php echo $LANG['action-signup']; ?></a>
                                                <a class="btn btn-secondary"
                                                   href="/login?continue=/<?php echo $profileInfo['username']; ?>"><?php echo $LANG['action-login']; ?></a>
                                            </div>
                                            <?php
                                        }
                                        ?>
                                    ...
                                    <div class="row row-cards row-deck loading-more-container <?php if (count($result['items']) < 20) echo 'hidden'; ?>">
                                        <div class="d-lg-block col-md-12 mb-5">
                                            <div class="list-view-banner p-3 d-flex justify-content-between align-items-center loading-more-banner">
                                                ...
                                                <a class="btn btn-primary btn-lg float-right d-flex justify-content-between align-items-center loading-more-button"
                ...
                <div class="modal-content">
                    <form id="new-message-form" action="/api/v1/method/msg.new" method="post">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title placeholder-title"
                                id="profile-new-message-title"><?php echo $LANG['dlg-message-title']; ?></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group field-message required">
                                <textarea id="message" class="form-control" name="messageText" rows="3"
                                          placeholder="<?php echo $LANG['dlg-message-placeholder']; ?>"
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                    data-dismiss="modal"><?php echo $LANG['action-cancel']; ?></button>
                            <button type="submit" class="btn btn-primary"><i
                                        class="fa fa-paper-plane mr-1"></i><?php echo $LANG['action-send']; ?></button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    if (!$myProfile && !$profileInfo['error'] && $profileInfo['state'] == ACCOUNT_STATE_ENABLED) {
                    ...
                    <form id="new-report-form" action="/api/v1/method/profile.report" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group field-description">
                                <label class="form-label"
                                       for="description"><?php echo $LANG['dlg-report-description-label']; ?></label>
                                <textarea id="description" class="form-control" name="description"
                                          placeholder="<?php echo $LANG['dlg-report-description-placeholder']; ?>"></textarea>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" disabled="disabled"
                                    class="btn btn-primary"><?php echo $LANG['action-report']; ?></button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal modal-form fade profile-block-dlg" id="profile-block-dlg" tabindex="-1" role="dialog"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form id="profile-block-form" action="/api/v1/method/blacklist.add" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                    data-dismiss="modal"><?php echo $LANG['action-no']; ?></button>
        ...
        <div class="modal modal-form fade profile-unblock-dlg" id="profile-unblock-dlg" tabindex="-1" role="dialog"
             aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
...
<script>
    ...
    $("#cover-upload").fileupload({
        formData: {
            accountId: <?php echo auth::getCurrentUserId(); ?>,
