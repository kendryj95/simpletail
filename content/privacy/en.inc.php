...
<p>Account information: when registering and setting up an account, you need to provide an email address, first name, last name, password, place of residence, etc.
    Some data is posted publicly and is used by us and other users to contact you.</p>
